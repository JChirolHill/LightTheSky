...
public class Sun extends Circle {
    private static final String HIT_PING = "src/FinalProject/Assets/ping.mp3";
    ...
    public Sun(Game game) {
        ...
        reset();
        this.setFill(new ImagePattern(new Image("FinalProject/Assets/sun.png")));

        // set up music player for beeps when hit paddle
        Media sound = new Media(new File(HIT_PING).toURI().toString());
