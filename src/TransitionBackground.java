...
public class TransitionBackground extends StackPane {
    private static final String BACKGROUND_FILE = "Assets/sunset.png";
    private static final String FOREGROUND_FILE = "Assets/night.png";
    private static final String OCEAN_FILE_LIGHT = "Assets/lightoceanhighlight.png";
    private static final String OCEAN_FILE_DARK = "Assets/darkoceanhighlight.png";
